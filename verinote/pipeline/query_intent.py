...
# tests/test_query_measure_unit.py, now a module away, pins this tuple's overlap
# with _MEASUREMENT_UNIT_SPELLINGS at 13 -- in
# test_the_digit_requirement_keeps_ordinary_prose_out_of_the_caveat. Widening
# the counters here reddens that file, not this one's.
