...
OLLAMA_EXTRACTION_SYSTEM = (
    ...
    "Preserve the source language, script, and named-entity spelling; do not "
    "translate, romanize, summarize, or invent facts. Put the exact original "
    "supporting phrase in note when a fact is normalized, compacted, corrected, "
