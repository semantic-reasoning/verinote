...
EXTRACTION_SYSTEM = (
    ...
    "Extract entity names in the source document's language and normalize relation "
    "labels to concise source-language predicates when useful. "
    "Preserve the source document's exact language, spelling, script, casing, "
    "and wording for subjects and objects; do not translate, romanize, summarize, "
    "or replace source terms with labels from another language. If a normalized "
    "fact comes from compact or corrected text, put the exact original phrase in note. "
